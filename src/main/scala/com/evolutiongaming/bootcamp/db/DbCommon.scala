...
object DbCommon {
  ...
  val populateDataSql: String =
    s"""
       ...
       |  ('$bookScala', '$authorOdersky', 'Programming in Scala', 2016, 'Tech'),
       |  ('$bookHPStone', '$authorRowling', 'Harry Potter and Philosopher''s Stone', 1997, 'Fantasy'),
       |  ('$bookHPSecrets', '$authorRowling', 'Harry Potter and the Chamber of Secrets', 1998, 'Fantasy');
       |""".stripMargin
